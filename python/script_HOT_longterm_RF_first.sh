...
#SBATCH -o msgs/hot_longterm_first_arousal_%j.txt
#SBATCH -e msgs/hot_longterm_first_arousal_errors_%j.txt
#SBATCH -p serial
#SBATCH -n 6
#SBATCH -t 3:00:00
...
python $USERAPPL/project_hoy/python/3_ml_classify_loocv_longterm_RF.py -i $WRKDIR/project_hoy/features_longterm_first5min_stats_omitShort_ValenceArousal_npNan.csv -o $WRKDIR/project_hoy/results -m "HOT arousal: first 5 minutes - RandomGridSearch" -d "HOT_FIRST_SMOTE"
