...
#SBATCH -o msgs/person_mo_output_%j.tx
#SBATCH -e msgs/person_mo_errors_%j.txt
#SBATCH -p serial
#SBATCH -n 3
#SBATCH -t 06:30:00
...
python $USERAPPL/project_hoy/python/taito_SVM_person.py -i $WRKDIR/project_hoy/output_MO_4_1.csv -o $WRKDIR/project_hoy/results -m "MO-4-1-PersonCV: CrossVal, Person split, Person upsample" -d "MO-4-1"
