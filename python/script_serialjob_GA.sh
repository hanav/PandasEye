...
#SBATCH -o msgs/general_ga_output_%j.tx
#SBATCH -e msgs/general_ga_errors_%j.txt
#SBATCH -p serial
#SBATCH -n 4
#SBATCH -t 03:30:00
...
python $USERAPPL/project_hoy/python/taito_SVM.py -i $WRKDIR/project_hoy/output_GA_4_1.csv -o $WRKDIR/project_hoy/results -m "GA-4-1: CrossVal,select features, split, upsample" -d "GA-4-1"
